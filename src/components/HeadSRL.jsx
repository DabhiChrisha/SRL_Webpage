      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <div className="order-2 lg:order-1">
            ...
            <blockquote className="pl-6 border-l-4 border-[#05877a] italic text-base md:text-lg text-gray-700 mb-8">
          ...
          <div className="relative flex justify-center order-1 lg:order-2">
            ...
            <div className="absolute -bottom-4 md:bottom-4 right-0 md:-right-4 bg-[#05877a] text-white text-xs md:text-sm px-4 md:px-5 py-2 rounded-full shadow-lg z-10 max-w-[150px] md:max-w-none text-center">
